...
La Tabla~\ref{tab:drafts-comparison} sintetiza las diferencias arquitectónicas y operativas entre el prototipo DRAFTS original y el sistema productivo DRAFTS++ desarrollado en este trabajo.
...
\hline
Detección + Clasificación & Etapas separadas, manual & Workflow integrado automatizado \\
\hline
Validación física & Ausente o mínima & SNR, DM, timestamps, coherencia \\
\hline
Bandas de frecuencia & 0.3-1.5 GHz (L-band) & 0.3-100 GHz (L + mm) \\
\hline
Estrategias HF & No implementadas & SNR-threshold implementado \\
\hline
...
\hline
Tiempo (obs. 2h FAST) & $\sim$45 min & $\sim$25 min (44\% más rápido) \\
\hline
\end{tabular}
\end{table}

Esta transformación establece a DRAFTS++ como un sistema operativo capaz de integrarse en flujos observacionales reales, superando las limitaciones del prototipo de investigación original y habilitando la detección multi-banda de transientes de radio.
...
% \subsubsection{Línea 4: Estrategias Alternativas del Autor de DRAFTS (PROBABLEMENTE LO ELIMINE)}
