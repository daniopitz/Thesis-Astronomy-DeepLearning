...
\subsection{Síntesis Comparativa: DRAFTS vs DRAFTS++}

La Tabla~\ref{tab:drafts-comparison} sintetiza las diferencias arquitectónicas y operativas entre el prototipo DRAFTS original y el sistema productivo DRAFTS++ desarrollado en este trabajo. \textbf{Nota importante: Ambos sistemas utilizan los mismos modelos de deep learning pre-entrenados (CenterNet y ResNet18); las diferencias radican exclusivamente en la ingeniería de software, la arquitectura del pipeline y las capacidades operativas del sistema.}
...
Esta transformación establece a DRAFTS++ como un sistema operativo capaz de integrarse en flujos observacionales reales, superando las limitaciones del prototipo de investigación original mediante mejoras de ingeniería de software y habilitando la detección multi-banda de transientes de radio sin modificar los modelos de deep learning subyacentes.
