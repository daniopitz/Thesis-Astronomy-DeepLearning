...
\begin{enumerate}
    \item \textbf{FAST-FREX}: Dataset de entrenamiento que valida flujo completo E2E con modelos CenterNet/ResNet18 integrados.
    
    \item \textbf{Pulsar B0355+54}: 752 pulsos teóricos en 117s que valida streaming, continuidad temporal y trazabilidad (732/752 detectados, 97.3\%).
    
    \item \textbf{FRB 121102}: Archivos multi-gigabyte que validan escalabilidad, gestión de memoria y descubrimiento científico (Recall 100\%, 2 nuevos bursts).
\end{enumerate}
...
FAST-FREX valida el flujo completo E2E: ingesta multi-formato, análisis automático de headers, visualización científica y integración automatizada de modelos CenterNet/ResNet18.
...
Este caso valida mejoras de preprocesamiento: contigüidad temporal quirúrgica, streaming por slices, trazabilidad temporal precisa, manejo de discontinuidades y validación física integrada.

Pulsar B0355+54\_FB\_20220918 (periodo 0.156s, 117.23s duración, 752 pulsos esperados). Resultados: 732/752 pulsos detectados (97.3\%), 718 clasificados como BURSTS.
...
FRB 121102 valida escalabilidad E2E con archivos multi-gigabyte que exceden memoria disponible, forzando operación integrada: ingesta masiva, chunking con solapamiento, gestión inteligente RAM/VRAM y procesamiento E2E sin intervención manual.

Se procesaron 6 archivos Effelsberg (~4GB cada uno) reportados por \cite{cruces2020frb121102}, con ground truth de 24 eventos confirmados. Resultados: 41 eventos detectados, Recall=100\% (24/24 eventos conocidos recuperados), 17 candidatos nuevos identificados, 2 confirmados como genuinos (SNR 6.3$\sigma$ y 12.0$\sigma$, DM~564 pc cm$^{-3}$).
