...
En la actualidad (2025) se conocen más de 4000 FRBs individuales %%\cite{veracasanova2025}, 
...
\paragraph{Energética y Escalas Temporales}
...
\paragraph{Dispersión Temporal: Firma de Propagación a través del Plasma}
...
\paragraph{Propiedades Espectrales y Polarización}
...
\paragraph{Tipología Observacional: \textit{One-offs} y Repetidores}
...
\subsubsection{Evolución Histórica del Campo: Desde el Descubrimiento Inicial hasta Catálogos Estadísticos}
...
\subsubsection{Fuentes Repetidoras de Referencia: Análisis Comparativo de FRB 121102, FRB 20180916B y FRB 20190520B}
...
\paragraph{FRB 121102: Caracterización Observacional y Significado Histórico}
...
\paragraph{FRB 20180916B: Periodicidad y Variabilidad Espectral}
...
\paragraph{FRB 20190520B: Entorno Circunestelar y Variabilidad Temporal}
...
\subsubsection{Síntesis: Implicaciones para Modelos de Progenitores}
...
\subsubsection{Evidencia Directa: SGR 1935+2154 y la Conexión con Magnetares Galácticos}
...
\subsubsection{Magnetares: Física Fundamental y Mecanismos de Emisión}
...
\subsubsection{Periodicidad en FRBs: Precesión, Orbitalidad y Modulación Ambiental}
...
\subsubsection{Escenarios Alternativos y Poblaciones Mixtas}
...
\subsubsection{Implicaciones Observacionales y Estrategias de Seguimiento}
...
\subsection{Magnetares y el Potencial del Régimen de Alta Frecuencia}

\subsubsection{Fundamentos de Magnetares: Campos Magnéticos Extremos y Mecanismos de Emisión Coherente}
...
\subsubsection{Magnetar del Centro Galáctico (PSR J1745-2900): Emisión hasta 154 GHz en Entornos de Alta Densidad}
...
\subsubsection{Detecciones con ALMA y Evidencia de Viabilidad en el Régimen Milimétrico}
...
\subsubsection{Lagunas Observacionales: Ausencia de Detecciones Confirmadas de FRBs Extragalácticos por Encima de 10 GHz}
...
\subsection{Desafíos Observacionales Diferenciales entre Regímenes de Frecuencia}

\subsubsection{Efectos Dispersivos en Frecuencias Milimétricas: Reducción de Contraste Temporal}
...
\subsubsection{Requisitos Técnicos Específicos: Resolución Temporal, Ancho de Banda y Sensibilidad}
...
\subsubsection{Estrategias de Adaptación para Alta Frecuencia: Polarización, Multi-banda y Re-entrenamiento con Datos Milimétricos}
...
\subsubsection{Arquitectura de Pipelines Clásicos: Procesamiento de Señales desde Voltaje hasta Detección}
...
\subsubsection{Implementaciones Estándar: PRESTO, Heimdall y TransientX}
...
\subsubsection{Técnicas de Mitigación de Interferencia de Radiofrecuencia}
...
\subsubsection{Máscara de Canal Estática}
...
\subsubsection{Filtro de DM = 0 (Zero-DM Filter)}
...
\subsubsection{Umbralizado en Tiempo Real}
...
\subsubsection{IQRM (Inter-Quartile Range Mitigation): Detección Robusta de Outliers}
...
\subsubsection{Filtro Z-dot: Prevención de Sobre-sustracción Canal a Canal}
...
\subsubsection{Curtosis Espectral (Spectral Kurtosis): Identificación de No-gaussianidades}
...
\subsubsection{Mitigación RFI Off-line (Secundaria): Refinamiento Post-procesamiento}
...
\subsubsection{Dedispersión por Fuerza Bruta: Implementación Directa y Optimizaciones}
...
\subsubsection{Dedispersión mediante Árbol (Tree Dedispersion): Algoritmos Divide-and-Conquer}
...
\subsubsection{Dedispersión Semicoherente: Optimización de Sensibilidad y Complejidad Computacional}
...
\subsubsection{Dedispersión en el Dominio de Fourier: Transformadas Eficientes}
...
\subsubsection{Filtrado Básico y Clustering: Agrupación Temporal y Espacial}
...
\subsubsection{Técnicas de Aprendizaje Automático para Clasificación: Redes Neuronales y Métodos Supervisados}
...
\subsubsection{FETCH: Sistema de Clasificación Automática mediante Redes Neuronales Convolucionales}
...
\subsubsection{DRAFTS: Sistema Integrado de Detección y Clasificación mediante CenterNet y Dedispersión Acelerada}
...
\subsubsection{Arquitectura de DRAFTS: CenterNet y ResNet18 Integrados}
...
\subsubsection{Rendimiento y Validación Experimental}
...
\subsubsection{Limitaciones Identificadas y Oportunidades de Mejora}
